...
ASSETS_PATH = OUTPUT_PATH / Path(r".\assets\assets\frame2")
...
canvas.create_text(
    ...
    204.0,
    anchor="nw",
    text="Apple-iPhone 13 Pro Max, 98% pouces, iPhone 13 Pro, 6.7 pouces, 12PM, 6.1G, ",
    fill="#191C1E",
    font=("PublicSans SemiBold", 14 * -1)
)
...
canvas.create_text(
    ...
    487.0,
    anchor="nw",
    text="L’iPhone 13 Pro Max combine design premium et performances exceptionnelles :\nÉcran Super Retina XDR 6,7” avec ProMotion pour une fluidité jusqu’à 120 Hz.\nPuce A15 Bionic, ultra-rapide et économe en énergie.\nSystème photo Pro : capteur principal amélioré, téléobjectif 3x, et Mode Cinématique pour des vidéos dignes d’un réalisateur.\nAutonomie renforcée pour une journée intensive.\nRésistance et durabilité : Cadre en acier inoxydable, écran Ceramic Shield ultra résistant et certification IP68 contre l’eau \net la poussière.\nCompatibilité MagSafe : Une charge rapide et sans fil, avec des accessoires aimantés pour un écosystème parfaitement intégré.\nUn smartphone parfait pour la photo, le multimédia et la performance au quotidien.",
    fill="#5F6C72",
    font=("PublicSans Regular", 14 * -1)
)
