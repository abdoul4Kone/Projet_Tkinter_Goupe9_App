...
ASSETS_PATH = OUTPUT_PATH / Path(r".\assets\assets\frameXiaomi")
...
canvas.create_text(
    ...
    197.0,
    anchor="nw",
    text="Xiaomi-Smartphone 14 Ultra, version globale, 16 Go, 512 Go, 120Hz, 6.73 pouces AMOLED, Snapdragon 8, Isabel 3, appareil photo Leica, 50MP, 90W HyperCharge",
    fill="#191C1E",
    font=("PublicSans Regular", 15 * -1)
)
...
canvas.create_text(
    ...
    288.0,
    anchor="nw",
    text="Categorie: Ordinateurs & téléphone",
    fill="#000000",
    font=("Inter", 14 * -1)
)
